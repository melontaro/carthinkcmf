...
class AdminPageController extends AdminBaseController
{
    ...
    {
        $content = hook_one('car_admin_page_index_view');
        ...
        $data        = $elementService->adminPageList($param);
        $data->appends($param);
    ...
    public function add()
    {
        $content = hook_one('car_admin_page_add_view');
        ...
        $pageThemeFiles = $themeModel->getActionThemeFiles('car/Page/index');
    ...
    public function addPost()
    {
        ...
        $result = $this->validate($data['element'], 'AdminPage');
        if ($result !== true) {
            $this->error($result);
        }
        ...
        $carElementModel->adminAddPage($data['element']);
        $this->success(lang('ADD_SUCCESS'), url('AdminPage/edit', ['id' => $carElementModel->id]));
    ...
    {
        $content = hook_one('car_admin_page_edit_view');
        ...
        $alias              = $routeModel->getUrl('car/Page/index', ['id' => $id]);
        $element['element_alias'] = $alias;
        $this->assign('page_theme_files', $pageThemeFiles);
    ...
    public function editElement()
    {
        ...
        $carElementModel->adminEditPage($data['element']);
    ...
    public function delete()
    {
        ...
        $result = $carElementModel->adminDeletePage($data);
        if ($result) {
