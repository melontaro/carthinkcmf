...
CREATE TABLE `cmf_nav_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '前台导航菜单表' ROW_FORMAT = Dynamic;
...
-- Records of cmf_user
-- ----------------------------
INSERT INTO `cmf_user` VALUES (1, 1, 0, 0, 1589790526, 0, 0, 0.00, 1589714024, 1, 'admin', '###f564d305997a92b5ab0cac10d819de02', 'admin', 'axuyin@163.com', '', '', '', '127.0.0.1', '', '', NULL);
